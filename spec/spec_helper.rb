...
def prepare_for_test context: :test
  migrator = SandthornDriverEventStore::Migration.new url: event_store_url, context: context
  migrator.migrate!
...
def event_store context: :test
  SandthornDriverEventStore::EventStore.new url: event_store_url, context: context
end
