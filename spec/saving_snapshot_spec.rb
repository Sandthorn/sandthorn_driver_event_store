...
# 		let(:save_events) { event_store.save_events test_events, aggregate_id, SandthornDriverEventStore::EventStore }
# 		let(:save_additional_events) { event_store.save_events additional_events, aggregate_id, SandthornDriverEventStore::EventStore }
...
# 				end
# 				let(:events) { event_store.get_aggregate aggregate_id, SandthornDriverEventStore::EventStore }
...
# 					expect { save_snapshot }.to raise_error SandthornDriverEventStore::Errors::NoAggregateError
# 				end
# 			end
...
# 					expect { event_store.save_snapshot data, aggregate_id }.to raise_error SandthornDriverEventStore::Errors::WrongSnapshotVersionError
# 				end
# 			end
